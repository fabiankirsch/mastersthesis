...
### Variant: LSTM with 1 layer - less units{#sec:FulfilledStimulatedInvolved}

::: {.cell .code tags=['hide']}
```python
variant_codename = 'FulfilledStimulatedInvolved'
